            ...
            <div class="card-header border-0">
                <div class="row align-items-center">
                    <div class="col" style="flex-basis: unset !important;">
                        <h3 class="mb-0" style="text-transform: uppercase;">ĐĂNG KÝ ĐỀ TÀI KHÓA LUẬN TỐT NGHIỆP</h3>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6" style="flex-basis: unset !important;">
                        ...
                        <div class="table-responsive ta">
                            ...
                            <table class="table align-items-center table-flush">
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="width: 30%">Link file : </td>
                                        <td>
                                            @if (!empty($studentTopic->st_outline_part))
                                            <a href="{!! asset('uploads/documents/' . $studentTopic->st_outline_part) !!}" target="_blank" download>Link download</a>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <h3 class="mb-0" style="text-transform: uppercase;">THÔNG TIN QUYỂN KHÓA LUẬN</h3>
                            ...
                            <table class="table align-items-center table-flush">
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="width: 30%">Link file : </td>
                                        <td>
                                            @if (!empty($studentTopic->st_thesis_book_part))
                                            <a href="{!! asset('uploads/documents/' . $studentTopic->st_thesis_book_part) !!}" target="_blank">Link download</a>
                                            @endif
                                        </td>
                                    </tr>
