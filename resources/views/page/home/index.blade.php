...
@section('content')
    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    @if (checkInTime($course->c_start_time, $course->c_end_time))
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col" style="flex-basis: unset !important;">
                                <h3 class="mb-0" style="text-transform: uppercase;">ĐĂNG KÝ KHÓA LUẬN TỐT NGHỆP CHO SINH VIÊN  KHOA {{ isset($department->parent) ? $department->parent->dp_name : '' }} Bộ Môn {{ $department->dp_name }}  Niên khóa {{ $course->c_name }}</h3>
                            </div>
                    ...
                    @else
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col" style="flex-basis: unset !important;">
                                    <h3 class="mb-0" style="text-transform: uppercase; color: red">Chú ý: Chưa đến thời gian đăng kí khóa luận tốt nghiệp. Xin vui lòng quay lại sau!</h3>
                                </div>
                                <div class="col text-right">
                                    {{--<a href="#!" class="btn btn-sm btn-primary">See all</a>--}}
                                </div>
