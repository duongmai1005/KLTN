            ...
            <div class="card-body" style="min-height: 142px">
                <div class="row">
                    <div class="col" style="padding: 0px">
                        <h5 class="card-title text-uppercase text-muted mb-0">Nộp đề cương</h5>
                ...
                <div class="row">
                    <p class="mt-3 mb-0 text-sm">
                        @if (isset($studentTopic->topic) && in_array($studentTopic->st_status_outline, [1, 2, 3]))
                    ...
                    <p class="mt-3 mb-0 text-sm col text-right">
                        @if (isset($studentTopic->topic) && checkInTime($studentTopic->topic->tc_start_outline, $studentTopic->topic->tc_end_outline) && in_array($studentTopic->st_status_outline, [0,3]))
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card card-stats">
            ...
            <div class="card-body" style="min-height: 142px">
                <div class="row">
                    <div class="col" style="padding: 0px">
                        <h5 class="card-title text-uppercase text-muted mb-0">Nộp quyển khóa luận</h5>
                ...
                <div class="row">
                    ...
                    <p class="mt-3 mb-0 text-sm col text-right">
                        @if (isset($studentTopic->topic) && checkInTime($studentTopic->topic->tc_start_thesis_book, $studentTopic->topic->tc_end_thesis_book) && in_array($studentTopic->st_status_thesis_book, [0,3]))
                            <a href="{{ route('user.thesis.book') }}" class="btn btn-sm btn-success">Nộp quyển khóa luận</a>
