                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div style="margin-top: 15px;">
                            <select name="gt_course_id" class="form-control">
                                <option value="">Chọn niên khóa</option>
                                @foreach($courses as $key => $course)
                                    <option  {{old('gt_course_id', isset($council) ? $council->gt_course_id : '') == $course->id ? 'selected=selected' : '' }}  value="{{$course->id}}">{{$course->c_name}}</option>
                                @endforeach
                            </select>
